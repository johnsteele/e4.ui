...
public class SimpleideSwitch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimpleidePackage.SIMPLE_IDE_APPLICATION: {
				SimpleIDEApplication simpleIDEApplication = (SimpleIDEApplication)theEObject;
			...
			case SimpleidePackage.EDITOR_PART_DESCRIPTOR: {
	 ...
	 * @generated
	 */
	public T1 caseSimpleIDEApplication(SimpleIDEApplication object) {
		return null;
	}
