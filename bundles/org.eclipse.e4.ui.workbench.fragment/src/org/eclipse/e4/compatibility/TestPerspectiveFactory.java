...
public class TestPerspectiveFactory implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		folder.addView("org.eclipse.jdt.junit.ResultView"); //$NON-NLS-1$
		folder.addView("org.eclipse.pde.runtime.LogView"); //$NON-NLS-1$
		...
		outputfolder.addView("org.eclipse.debug.ui.VariableView"); //$NON-NLS-1$
